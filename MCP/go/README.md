# Ad Exchange Buyer API MCP Server

This MCP (Model Content Protocol) server provides access to Ad Exchange Buyer API API functionality through HTTP, HTTPS, and STDIO transport modes.
